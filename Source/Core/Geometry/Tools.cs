	...
	public static class Tools
	{
		...
		public static bool DrawLines(IList<DrawnVertex> points)
		{
			...
			if(points.Count > 0)
			{
				...
				if(newlines.Count > 0)
				{
					//Console.WriteLine("Guigui : close the drawing");
				...
				foreach(Linedef ld in newlines)
				{
					//Console.WriteLine("Guigui : checking interior of lines");
				...
				{
					//Console.WriteLine("Guigui : new sector ?");
					...
					if((ld.FrontInterior && !frontsdone[i]) || (!ld.FrontInterior && !backsdone[i]))
					{
						...
						if(sectorlines == null)
							Console.WriteLine("Guigui : cannot make new sector from here :(");

						if (sectorlines != null)
						{
							//Console.WriteLine("Guigui : can make new sector !");
							sidescreated = true;
